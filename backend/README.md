...
## Project Structure
    ...
    ├── tst_tc489_eyfurphf_121797  # Django project configurations
...
1. Clone this repo and `cd tst_tc489_eyfurphf_121797`
...
2. Clone this repo and `cd tst_tc489_eyfurphf_121797`
